...
export default function PayCard({ debt, onClick }) {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-4">
        ...
        <span className="px-3 py-1 bg-red-900/30 text-red-400 text-sm font-medium rounded-full border border-red-800/50">
      ...
      <div className="space-y-3">
        <div className="flex items-center text-zinc-300">
          ...
          <span className="font-medium text-white">Acreedor: {debt.acreedor}</span>
        </div>
        ...
        <div className="pt-3 mt-3 border-t border-zinc-700">
          <div className="flex justify-between items-center">
            ...
            <span className="text-lg font-bold text-red-400">{formatAmount(calculateTotal())}</span>
          </div>
        </div>
      </div>
    </div>
